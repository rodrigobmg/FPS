...
{
    vec Center;            // Center of the box.
    vec Extents;           // Distance from the center to each side.
};
...
struct OrientedBox
{
    vec Center;            // Center of the box.
    vec Extents;           // Distance from the center to each side.
    vec4 Orientation;       // Unit quaternion representing rotation (box -> world).
};

struct Frustum
{
    vec Origin;            // Origin of the frustum (and projection).
    vec4 Orientation;       // Unit quaternion representing rotation.
