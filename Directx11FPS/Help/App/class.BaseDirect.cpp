...
void BaseDirect::Initialize() {
	...
	CreateDepthStencilState(false); // chceme aj vypinat z-buffer
...
void BaseDirect::TurnZBuffer(bool x) {
	m_deviceContext->OMSetDepthStencilState(m_depthStencilState[ x ? 0 : 1], 1); // (int) !x		;P
}
