...
// CPUInfo.cpp
// 
// CPUInfo class implementation.
//
// Copyright (c) Microsoft Corporation. All rights reserved.
//-------------------------------------------------------------------------------------
#include "class.CPUInfo.h"
#include <stdlib.h>
#include <crtdbg.h>
...
//---------------------------------------------------------------------------------
// Name: DefaultImpl
// Desc: Provides a default implementation for the ICPUInfo interface when
...
//       Pattern.
//---------------------------------------------------------------------------------
class DefaultImpl : public ICPUInfo
{
public:
    BOOL IsDefaultImpl() const {return TRUE; }
...
//       ICPUInfo interface.  This is a ConcreteImplementor class in the
//       traditional Bridge Pattern.
//---------------------------------------------------------------------------------
class GlpiImpl : public ICPUInfo
{
public:
...
//---------------------------------------------------------------------------------
// Name: CpuidImpl
// Desc: Provides the CPUID instruction implementation for the ICPUInfo
//       interface.  This is a ConcreteImplementor class in the traditional Bridge
//       Pattern.
//---------------------------------------------------------------------------------
class CpuidImpl : public ICPUInfo
{
public:
...
//-------------------------------------------------------------------------------------
BOOL CPUInfo::IsDefaultImpl() const
{
    return m_pImpl->IsDefaultImpl();
}

//-------------------------------------------------------------------------------------
// Name: CPUInfo::ForceCpuid
...
//-------------------------------------------------------------------------------------
void CPUInfo::ForceCpuid( BOOL bForce )
{
    Destroy();
...
//-------------------------------------------------------------------------------------
// Name: CPUInfo::Destroy
//-------------------------------------------------------------------------------------
void CPUInfo::Destroy()
{
    delete m_pImpl;
    m_pImpl = NULL;
}
