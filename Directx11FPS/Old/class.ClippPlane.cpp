...
ClipPlane::ClipPlane(const ClipPlane& other)
{
}
...
bool ClipPlane::Initialize(ID3D11Device* device, HWND hwnd)
{
	bool result;


	// Initialize the vertex and pixel shaders.
	result = InitializeShader(device, hwnd, L"../Media/clipplane.vs", L"../Media/clipplane.ps");
	if(!result)
	{
		return false;
	}
...
bool ClipPlane::Render(ID3D11DeviceContext* deviceContext, int indexCount, D3DXMATRIX worldMatrix, 
...
bool ClipPlane::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	HRESULT result;
...
void ClipPlane::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename)
{
	char* compileErrors;
...
bool ClipPlane::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, 
...
void ClipPlane::RenderShader(ID3D11DeviceContext* deviceContext, int indexCount)
{
